...
int main(void)
{
    ...
    unsigned char *fileData = LoadFileData("LiberationMono-Regular.ttf", &fileSize);
    ...
    fontSDF.glyphs = LoadFontData(fileData, fileSize, 32, 0, 0, FONT_SDF);
    ...
    Shader shader = LoadShader(0, TextFormat("../data/shaders/glsl%i/sdf.fs", 330));
    printf("%d\n", GLSL_VERSION);
